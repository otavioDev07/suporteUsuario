...
function editarChamado(id, userEmail, logado) {
    return __awaiter(this, void 0, void 0, function () {
        var apiUrl, response, data, email_cham, setor_cham, problema_cham, detalhes_cham, id_cham, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                ...
                case 3:
                    data = _a.sent();
                    email_cham = data.email;
                    setor_cham = data.setor;
                    problema_cham = data.problema;
                    detalhes_cham = data.detalhes;
                    id_cham = data.id;
